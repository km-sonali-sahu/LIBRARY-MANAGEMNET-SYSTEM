...
$book_number="";
$student_name="";
//  for joining the issued book and user  table  to fetch the name == student id this is the query 
 $query = "select issued_books.book_name,issued_books.author_name,issued_books.book_number,users.Name from issued_books left join users on issued_books.student_id = users.id";
...
<div class="row">
	...
	<table class="table table-dark table-hover">
		...
		<legend style="font-size: 30px;color: cyan;background-color: black;font-style: italic;border-bottom: 10px solid red">List of Issued Books </legend>
