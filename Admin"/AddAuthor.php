			...
			<div class="col-md-4">
				<div class="bg-light">
					<form action="" method="post">
						<legend style="text-align: center;font-size: 30px; color: black; font-style: italic; font-weight: bold;"> Add Author </legend>
						...
						<button class="btn btn-warning" name="add_author" style="font-weight: bold;">Add Author</button>
					</form>
				</div>
			</div>
			<div class="col-md-4"></div>
...
if (isset($_POST['add_author'])) {
	...
	$query = " insert into authors values('','$_POST[authorname]');";
