...
<html>
<head>
	<title>View Registerd User</title>
		...
		<nav class=" navbar navbar-expand-lg  navbar-dark bg-dark ">
			<div class="container-fluid">
				<div class="navbar-header">
					<a href="" class="navbar-brand ab"> Library Management System(LMS)</a>
				</div>
				<span>
					<strong>
...
<div class="row">
	...
	<table class="table table-hover table-warning text-black">
		<center >
			
		<legend style="font-size: 30px;color: cyan;background-color: black;font-style: italic;border-bottom: 10px solid red">View Registered User</legend>
