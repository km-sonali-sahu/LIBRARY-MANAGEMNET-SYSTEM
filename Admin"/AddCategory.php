			...
			<div class="col-md-4">
				<div class="bg-light">
					<form action="" method="post">
						<legend style="text-align: center;font-size: 30px; color: black; font-style: italic; font-weight: bold;"> Add Category </legend>
						<div class="form-group">
							<label for="cat_name"style="font-weight: bold;">Category Name</label>
							<input type="text" name="cat_name" class="form-control abc" required="">
						</div>

						<button class="btn btn-warning" name="add_category" style="font-weight: bold;">Add Category</button>
					</form>
				</div>
			</div>
			<div class="col-md-4"></div>
