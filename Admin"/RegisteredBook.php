...
$query = "select books.book_name,books.book_price,books.book_number,authors.author_name from books left join authors on books.author_id=authors.author_id ";
...
<html>
<head>
	<title>View Registered Book</title>
...
<div class="row">
	...
	<table class="table table-dark table-hover">
		...
		<legend style="font-size: 30px;color: cyan;background-color: black;font-style: italic;border-bottom: 10px solid red">View Registered Book</legend>
